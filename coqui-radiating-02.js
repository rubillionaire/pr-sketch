...
const draw = regl({
  ...
  vert: `
    ...
    uniform float width, aspect, charOffset, tick, radiusOffsetNormalized;
...
async function main () {
  ...
  const markMeshes = ({ radiusOffset=0.0 }={}) => {
  ...
  const props = markMeshes({ radiusOffset: 0.0 })
    .concat(markMeshes({ radiusOffset: 0.5 }))
  regl.frame(() => {
