  ...
  return html`<body class=${prefix}>
    ...
    <main class="stack">
        ...
        <div class="stack items-center">
          <div class="max-width-text">
            <p>
              ...
              sun light is cast from across the equator casting
      ...
      <section class="bg-dark">
        <div class="stack items-center p-8">
          <div class="max-width-text">
            <p class="text-light">
      ...
      <section class="bg-light">
        <div class="stack items-center p-8">
          <div class="max-width-text">
            <p class="text-dark">
              Put it all together and we get the full cycle
              on display.
            </p>
          </div>
        </div>
...
async function mapScroll2Store (state, emitter) {
  ...
  state.nightMap = tickPositions.midnight
