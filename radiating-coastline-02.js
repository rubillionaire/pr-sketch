...
// answer: yes we are, lets remove this concept of
const featureTypes = ['test.new'].concat(featuresJSON)
...
console.log({decodedGeorender})
    ...
    const style = await makeStylesheet(stylesheet, { features: featureTypes })
