 ...
 * - 6 - wip broken, bezier inteprolation on lower sample rate
  ...
  frag: glsl(`
    ...
    void main () {
      ...
      if (vPosition.w == 0.0) {
        ...
        color = vec3(0.5);
        // ambient = ambientLightAmount * color;
        float cosTheta = dot(normalize(vNormal), normalize(lightDir));
